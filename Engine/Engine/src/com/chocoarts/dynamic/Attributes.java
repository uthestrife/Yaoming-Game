...
public class Attributes {
    ...
    public static Attributes copy(Attributes parentAttrib) {
        Attributes newAttrib = new Attributes();
        
        for( int i = 0 ; i < ATTRIBUTE_AMOUNT ; i++ ){
            newAttrib.objects[i] = parentAttrib.objects[i];
        }
        newAttrib.filename = parentAttrib.filename;
        return newAttrib;
    }
